    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor semper orci, sit amet dapibus libero auctor eget.
        </Text>
        <Text style={styles.text}>
          Nulla facilisi. Morbi non justo massa. Fusce in dolor in neque iaculis tempor.
        </Text>
      </View>
    </Page>
  </Document>
