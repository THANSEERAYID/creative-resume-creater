...
const navigation = [
  ...
  { name: 'Create', href: 'create-resume/', current: false },
        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-14 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-start ml-12 sm:items-stretch sm:justify-start">
                    ...
                    {navigation.map((item) => (
                      ...
                      style={{ fontFamily:'sans-serif'}}
                        ...
                        className={classNames(
                            currentItem == item.name ? 'text-[#A020F0]' : 'text-gray-300 hover:text-blue-100 hover:text-white',
